...
namespace WebApi_Tutorial1.Controllers
{
    ...
    public class PersonelController : ControllerBase
    {
        ...
        public List<Personel> _listPersonleList { get; set; }
        public List<Personel> ListPersonleList
        {
            get
            {
                if (_listPersonleList == null)
                    GeneratePersonelData();
                return _listPersonleList;
            }

            set
            {
                _listPersonleList = value;
            }
        }

        private void GeneratePersonelData()
        {
            ListPersonleList = new List<Personel>
            {
